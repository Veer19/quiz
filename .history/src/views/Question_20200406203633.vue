    ...
    <div v-if="questionLoaded">
        ...
        <div class="container-fluid mt--7">
                        ...
                        <div class="card-body">
                            <div class="row icon-examples">
                                <div class="col-lg-6 col-md-6 col-sm-12"
                                    ...
                                    <button type="button"
                                            v-if="showAnswers" :style="selectedColor(givenAnswers[currentQuestionNumber-1] == option)"
                                        ...
                                        <div>
                                          <!-- {{quizObj.questions[currentQuestionNumber-1]}} -->
                                            <!-- <div v-if="givenAnswers[currentQuestionNumber-1] == option">Selected</div> -->
            ...
            <div >
              ...
              <!-- <base-button v-if="quizObj.quesions[currentQuestionNumber-1].marked" type="warning" class="float-right" style="margin-right: 16px" @click="unmark(currentQuestionNumber)">Unmark</base-button>-->
              <base-button type="warning" class="float-right" @click="mark(currentQuestionNumber)">Mark for Review</base-button> 
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      optionSelected(selected){
        ...
        // this.onclk = true;
        if(this.givenAnswers[this.currentQuestionNumber-1] == selected){
          this.givenAnswers[this.currentQuestionNumber-1] = ""
          return;
        }
        this.givenAnswers[this.currentQuestionNumber-1] = selected
