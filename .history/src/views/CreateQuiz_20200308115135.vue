                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <a href="#!"  v-if="questionNumber!=0" @click="moveUp(questionNumber)" class="btn btn-sm btn-primary">Move Up</a>
                                <a v-if="questionNumber!=quizObj.questions.length-1" @click="moveDown(questionNumber)" class="btn btn-sm btn-primary">Move Down</a>
                                <a href=""  @click="deleteQuestion(questionNumber)" class="btn btn-sm btn-primary">Delete</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
