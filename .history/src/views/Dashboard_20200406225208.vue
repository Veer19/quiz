              ...
              <div class="columns col-xl-3 col-lg-6" v-for="quiz in quizList" v-bind:key="quiz.title">
                    ...
                    >
                        ...
                        <template slot="footer">
                            <span>{{quiz.timings.from}}</span>-<span>{{quiz.timings.to}}</span>
                            <span class="float-right">{{event.timings.duration}}</span>
                            <br>
                            <br>
                        <router-link :to="{path:'/dashboard/'+quiz.uid}" v-if="!event.register"><base-button type="primary">Register</base-button></router-link>
