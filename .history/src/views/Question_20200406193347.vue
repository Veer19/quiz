                                    ...
                                    <button type="button"
                                        ...
                                        <div>
                                          <!-- {{quizObj.questions[currentQuestionNumber-1]}} -->
                                            <div v-if="quizObj.questions[currentQuestionNumber-1].selected == option" :key="quizObj.questions[currentQuestionNumber-1].selected">Selected</div>
  ...
  export default {
    ...
    methods: {
      ...
      optionSelected(selected){
        ...
        console.log(this.quizObj.questions[this.currentQuestionNumber-1])
        // console.log(this.quizObj.questions[this.currentQuestionNumber-1])
      }
