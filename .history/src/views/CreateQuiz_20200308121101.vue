                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-right">
                                    <a v-if="questionNumber!=0" @click="moveUp(questionNumber)" class="rightButtons btn btn-sm btn-primary">Move Up</a>
                                    <a v-if="questionNumber!=quizObj.questions.length-1" @click="moveDown(questionNumber)" class="rightButtons btn btn-sm btn-primary">Move Down</a>
                                    <a @click="deleteQuestion(questionNumber)" class="rightButtons btn btn-sm btn-primary">Delete</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
