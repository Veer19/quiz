                        ...
                        <div class="card-body">
                            <div class="row icon-examples">
                                <div class="col-lg-6 col-md-6 col-sm-12"
                                    ...
                                    <button type="button"
                                            v-if="showAnswers" :style="selectedColor(quizObj.questions[currentQuestionNumber-1] == option)"
  ...
  export default {
    ...
    methods: {
      ...
      optionSelected(selected){
        ...
        // this.onclk = true;
        if(this.quizObj.questions[this.currentQuestionNumber-1] == selected){
          this.quizObj.questions[this.currentQuestionNumber-1] = ""
          return;
        }
